...
' Programmer:   Brandon Meyer on 10/19/2016
...
Public Class frmMain
        ...
        Else
            ...
            If radQueen.Checked Then
                If radStandard.Checked Then
                    dblDailyRoomChg = dblDAILY_ROOM_CHG_QUEEN_STAND
                Else
                    dblDailyRoomChg = dblDAILY_ROOM_CHG_QUEEN_ATRIUM
                End If
            Else
                If radStandard.Checked Then
                    dblDailyRoomChg = dblDAILY_ROOM_CHG_KING_STAND
                Else
                    dblDailyRoomChg = dblDAILY_ROOM_CHG_KING_ATRIUM
                End If
            End If
    ...
    Private Sub ClearLabels(sender As Object, e As EventArgs) Handles txtRooms.TextChanged, txtNights.TextChanged,
            txtAdults.TextChanged, txtChildren.TextChanged, radQueen.CheckedChanged, radKing.CheckedChanged,
            radStandard.CheckedChanged, radAtrium.CheckedChanged, chkParkingFee.CheckedChanged
